					...
					<div className="page-course">
						...
						<div className="page-course__header infoBg topP15 bottomP15 color-white">
							<div className="container">
								<h1 className="text-title_21">رابط و تجربه کاربری آموزش UI/UX مقدماتی تا پیشرفته</h1>
								<div className="page-course__detail flex hCenter bottomM15">
									<span className="icon icon-circle-chake text24 leftM20"></span>
									<div>
						...
						<SnappCourseLayout title="این دوره شامل" className="boxShadow15">
							<div className="page-course__detail flex center">
								<span className="icon icon-movie_time text24 leftM15 gray1"></span>
								<span className="text-p__14 gray1">مدت زمان دوره</span>
								<span className="text-p__15 rightMauto">28:14:55</span>
							</div>
						</SnappCourseLayout>

						<SnappCourseLayout title="مطالبی که در این دوره یاد می‌گیرم" className="boxShadow15">
							<div className="page-course__detail flex">
								<span className="icon icon-circle-chake text24 leftM15 success"></span>
								<span className="text-p__14">مطالبی که در این دوره یاد می‌گیرم</span>
							</div>
						</SnappCourseLayout>
						...
						<SnappCourseLayout title="آموزش‌های این دوره" className="boxShadow15">
							<Accordion className="chili-more-menu__item-wrapper">
								<AccordionItem className="chili-more-menu__item">
									...
									>
										<div className="page-course__detail flex">
											<span className="icon text24 leftM15"></span>
									...
									<AccordionItemBody className="accordion__body borderAll border220 padd10">
										<div className="accordion__ul">
											<div className="accordion__list">
												<div className="page-course__detail flex center">
													<span className="icon icon-circle-play text24 leftM15 success"></span>
													<span className="text-p__14">
														<span>روش بررسی و تشخیص پرسوناها پروژه</span>
														<br/>
														<span className="text12 gray6">28:14:55</span>
														</span>
													<span className="icon-circle-play success rightMauto text20"></span>
												</div>
											</div>
										</div>
									</AccordionItemBody>
						...
						<SnappCourseLayout className="boxShadow15" title="تهیه شده توسط بابک حقیقی">
							<div className="page-course__detail flex hCenter topM5">
								<div className="">
									<span className="icon icon-circle-chake text24 leftM15"></span>
								</div>
								<div>
									<div className="hCenter bottomM10">
										<span className="icon icon-circle-chake text24 leftM10 gray1"></span>
						...
						<SnappCourseLayout title="نظرات" moreOption='نظر 156' className="boxShadow15">
							<div className="page-course__detail borderAll border220 padd10 round10">
								<div className="flex hCenter">
									<span className="icon icon-movie_time text24 leftM15"></span>
									<span className="text-p__14">محمد رستمی</span>
									<span className="text-p__14 rightM5 text12 gray8">(2 روز پیش)</span>
									<span className="text-p__15 rightMauto hCenter">
										<span className="bold text16">4</span>
										<span className="icon icon-star-fill text14 rightM5 success"></span>
									</span>
								</div>
								<p className="bottomM topP15 bottomP5">روش طراحی پروتوتایپ با استفاده از وایرفرم و روابط بین صفحات بصورت تعاملی جهت درک بهتر</p>
							</div>
						</SnappCourseLayout>
						...
						<SnappCourseLayout className="bottomM15 boxShadow15">
							...
							<div className="page-course__detail flex center">
								<span className="icon icon-warning text24 leftM15"></span>
								<span className="text-p__14">اعلام گزارش مشکل در محتوای این دوره</span>
								<span className="icon icon-arrow-left text40 gray1 rightMauto"></span>
							</div>
